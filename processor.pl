...
if ( $exit_code == $SUCCESS ) {
    ...
    if (( $input_file eq "" ) || ( $output_file eq "" ) || ( $src_regex eq "" ) || ( $data_type eq "" )) {
            ...
            if ( $src_regex eq "" ) {
                ...
                if ( $dst_regex eq "" ) {
                    ...
                    if ( $input_line =~ /$src_regex/ ) {
                        ...
                        print OUTPUT "$comment_prefix $right_now - Line commented out by script:\n";
                        print OUTPUT "$comment_prefix $0\n";
                    ...
                    if ( $input_line =~ /$src_regex/ ) {
                        ...
                        print OUTPUT "$comment_prefix $right_now - The following line was commented out\n";
                        print OUTPUT "$comment_prefix by automation script $0\n";
                        print OUTPUT "$comment_prefix Original line was:\n";
                        print OUTPUT "$comment_prefix $original_line\n";
                        print OUTPUT "$input_line\n";
                    } else {
                        print OUTPUT "$input_line\n";
                    }
