      ...
      *--- informational messages -------------
       01  MSG-EXIT                                PIC  X(80)
           VALUE 'Transaction END(SB00). Enter -CESF LOGOFF- to quit.
      -            '             '.
      ...
      -            '             '.
       ...
       01  MSG-TABLE.
           ...
           05  FILLER PIC X(79) VALUE 'Problem in access program (RSSBT0
      -                               '01)         '.
      ...
      *    END-IF.
           ...
           IF COMM-FONC  =  'SEND'
              ...
              END-IF
              IF COMM-NUM-MESS = 12
                 MOVE COMM-SQLCODE TO VMESSO(43:4)
              END-IF
      ...
      *- Move data to the map....
       FILL-SCREEN.
           ...
           MOVE   'RSSBT000'       TO      VPGMSCRO.
      
           EXEC CICS ASKTIME ABSTIME(ABS-TIME)  END-EXEC.
           EXEC CICS FORMATTIME ABSTIME(ABS-TIME)
                                DDMMYY(WS-DATE8) DATESEP('-')
           END-EXEC.
