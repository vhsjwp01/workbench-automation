...
# WHAT: Munge SQL statements in Cobol programs
# WHY:  Aked to
#
if [ ${exit_code} -eq ${SUCCESS} ]; then
...
# WHAT: Munge for FTP get commands in ksh JCL conversion 
# WHY:  Asked to
#
if [ ${exit_code} -eq ${SUCCESS} ]; then
...
# WHAT: Munge DFDSS tar backup conversion
# WHY:  Asked to
#
if [ ${exit_code} -eq ${SUCCESS} ]; then
